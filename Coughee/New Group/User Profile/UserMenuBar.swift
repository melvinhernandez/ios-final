...
class UserMenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let menuBarItems = ["Profile", "Caffeine Intake", "My Posts"]
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        userContent?.scrollToMenuIndex(menuIndex: indexPath.item)
    }
...
class UserMenuCell: BaseCollectionCell {
